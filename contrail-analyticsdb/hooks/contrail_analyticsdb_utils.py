...
def servers_ctx():
    ...
    controller_ip_list = sorted(common_utils.json_loads(config.get("controller_ips"), list()), key=sort_key)
    controller_data_ip_list = sorted(common_utils.json_loads(config.get("controller_data_ips"), list()), key=sort_key)

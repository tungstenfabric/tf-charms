...
def remove_created_files():
    ...
    common_utils.remove_file_if_exists(BASE_CONFIGS_PATH + "/contrail-vrouter-agent.conf")
    common_utils.remove_file_if_exists(BASE_CONFIGS_PATH + "/common_vrouter.env")
    ...
    common_utils.remove_file_if_exists("/etc/apparmor.d/libvirt/TEMPLATE.qemu")

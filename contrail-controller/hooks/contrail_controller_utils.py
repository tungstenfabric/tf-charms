...
def _has_provisioning_finished():
    ...
    return (
        _has_provisioning_finished_for_container("configapi_provisioner_1", CONFIG_API_CONFIGS_PATH) and
        _has_provisioning_finished_for_container("control_provisioner_1", CONTROL_CONFIGS_PATH)
    )

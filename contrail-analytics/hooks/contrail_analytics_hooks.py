...
def _update_analyticsdb(rid=None):
    ...
    for rid in ([rid] if rid else relation_ids("contrail-analyticsdb")):
        relation_set(relation_id=rid, relation_settings=settings)
...
def _update_cluster(rid=None):
    ...
    for rid in ([rid] if rid else relation_ids("analytics-cluster")):
        relation_set(relation_id=rid, relation_settings=settings)
...
def _notify_proxy_services(rid=None):
    ...
    for rid in ([rid] if rid else relation_ids("http-services")):
        relation_set(relation_id=rid, relation_settings=settings)
